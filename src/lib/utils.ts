...
export function isDisplayableArticleImage(src?: string): boolean {
  if (!src) return false;
  return !/placehold\.co|placeholder|us_flag|usa-banner|\/themes\/|\/profiles\/|favicon|wordmark|header_logo/i.test(
    src
  );
}
